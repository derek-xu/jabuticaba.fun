...
import { questions, fairAnswers } from "./global/questions.js";
import "./App.css";
    ...
    return (
      <div className="quiz-container">
        ...
        <div className="results">
          <h2>
            Your Fairness Score: {score}/{questions.length}
          </h2>
          <p className="percentage">{percentage}%</p>
          <div className="score-message">
            {percentage >= 80 && (
              <p>Excellent! You have a strong sense of fairness.</p>
            )}
            {percentage >= 60 && percentage < 80 && (
              <p>Good! You generally recognize unfair situations.</p>
            )}
            {percentage >= 40 && percentage < 60 && (
              <p>Fair. You have room to improve your fairness awareness.</p>
            )}
            {percentage < 40 && (
              <p>Consider reflecting on what fairness means to you.</p>
            )}
          </div>
